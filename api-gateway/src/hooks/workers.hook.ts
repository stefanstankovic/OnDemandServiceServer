...
export class WorkersHook {
    ...
    private async userConnected(...args: any[]) {
        ...
        await this._services.workersClient.addOrUpdateWorker(worker.grpsWorker);
    }
    ...
    private async onChangeLocation(...args: any[]) {
        ...
        await this._services.workersClient.updateWorkerLocation(locationObject.grpcLocation);
    }
}