...
import {
  IUserClient,
  UserClient as GrpcUserClient,
} from "../../grpc/_proto/user/user_grpc_pb";
import {
  UserData,
  UpdateUserRequest,
  UserDataResponse,
...
export class UserClient extends ClientBase<IUserClient> {
  ...
  public async updateUser(
    ...
    return new Promise<UserDataResponse>((resolve, reject) => {
      this._client!.updateUser(
        updateUserRequest,
        (error: grpc.ServiceError | null, response: UserDataResponse): void => {
          if (error) {
            reject(error);
          }
          resolve(response);
  ...
  public async updateUserDetails(
    ...
    return new Promise<UserDetailsResponse>((resolve, reject) => {
      this._client!.updateUserDetails(
  ...
  public async findUserDetailsByUserId(
    ...
    return new Promise<UserDetailsResponse>((resolve, reject) => {
      this._client!.findUserDetailsByUserId(
        idData,
        (
          error: grpc.ServiceError | null,
          response: UserDetailsResponse
  ...
  public async updateWorkerOptions(
    id: string,
    workerOptions: WorkerOptions
  ): Promise<WorkerOptionsResponse> {
    ...
    return new Promise<WorkerOptionsResponse>((resolve, reject) => {
      this._client!.updateWorkerOptions(
        updateOptionsRequest,
        (
          error: grpc.ServiceError | null,
          response: WorkerOptionsResponse
        ): void => {
          if (error) {
            reject(error);
          }
  ...
  public async findWorkerOptionsByUserId(
    userId: string
  ): Promise<WorkerOptionsResponse> {
    if (!this._client) {
      throw new Error("User Client isn't initialized.");
    ...
    return new Promise<WorkerOptionsResponse>((resolve, reject) => {
      this._client!.findWorkerOptionsByUserId(
        idData,
        (
          error: grpc.ServiceError | null,
          response: WorkerOptionsResponse
