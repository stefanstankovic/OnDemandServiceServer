...
class UserHandler implements IUserServer {
  addUser = (
    ...
    userHelper.AddUser(call.request).then((response: Response) => {
  ...
  updateUser = (
    ...
    userHelper.UpdateUser(call.request).then((response) => {
      callback(null, response);
    });
  };
  ...
  findUserById = (
    ...
    userHelper.FindUserById(call.request).then((response) => {
      callback(null, response);
    });
  };
  ...
  findUsers = (
    ...
    callback: grpc.sendUnaryData<FindUsersResponse>
  ): void => {
  ...
  addUserDetails = (
    ...
    userDetailsHelper.AddUserDetails(call.request).then((response) => {
      callback(null, response);
    });
  };
