...
interface IUserService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    findWorkerOpstionsByUserId: IUserService_IFindWorkerOpstionsByUserId;
...
interface IUserService_IFindWorkerOpstionsByUserId extends grpc.MethodDefinition<user_pb.Id, user_pb.WorkerOptionsResponse> {
    path: string; // "/user.User/FindWorkerOpstionsByUserId"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<user_pb.Id>;
    requestDeserialize: grpc.deserialize<user_pb.Id>;
...
export interface IUserServer {
    ...
    findWorkerOpstionsByUserId: grpc.handleUnaryCall<user_pb.Id, user_pb.WorkerOptionsResponse>;
...
export interface IUserClient {
    ...
    findWorkerOpstionsByUserId(request: user_pb.Id, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
    findWorkerOpstionsByUserId(request: user_pb.Id, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
    findWorkerOpstionsByUserId(request: user_pb.Id, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
...
export class UserClient extends grpc.Client implements IUserClient {
    ...
    public findWorkerOpstionsByUserId(request: user_pb.Id, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
    public findWorkerOpstionsByUserId(request: user_pb.Id, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
    public findWorkerOpstionsByUserId(request: user_pb.Id, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: user_pb.WorkerOptionsResponse) => void): grpc.ClientUnaryCall;
